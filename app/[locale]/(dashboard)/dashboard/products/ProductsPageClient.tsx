...
import { useProducts, type Product, type IndustryType } from "./hooks/useProducts";
...
export default function ProductsPageClient({ initialData }: { initialData?: { products: Product[]; totalProducts: number; industryType: IndustryType } }) {
