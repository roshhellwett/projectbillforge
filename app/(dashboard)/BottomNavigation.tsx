...
export default function BottomNavigation({ currentPage = "dashboard" }: BottomNavigationProps) {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden glass-heavy border-t-0 shadow-[0_-8px_32px_rgba(91,33,182,0.1)] dark:shadow-[0_-8px_32px_rgba(0,0,0,0.3)] pb-[env(safe-area-inset-bottom)]">
